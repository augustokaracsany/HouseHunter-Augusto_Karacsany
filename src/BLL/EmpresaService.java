...
public class EmpresaService {
    ...
    // Se podrìa mostrar con JTable esto.
    ...
    public boolean procesarReserva(LocalDate inicio, LocalDate fin, int invitados) throws SQLException {
     ...
     // Recupera las reservas filtradas por el ID único de la empresa.
    // ( Usa empresa.getId() heredado de Persona. ).
    ...
    public List<Reserva> obtenerReservas() {
     ...
     // Módulo: Gestión de Eventos.
     // Lista de plantillas de diseño de invitaciones disponibles. < Darle uso con los JTable.
