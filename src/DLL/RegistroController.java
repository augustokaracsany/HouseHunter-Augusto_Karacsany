...
public class RegistroController {
    ...
    public boolean procesarRegistro(String email, String password, Rol rol, String datoPrincipal, String datoSecundario, String datoTerciario) {
        ...
        if (email == null || email.trim().isEmpty() || password == null || password.trim().isEmpty()) {
            System.out.println("Registro: Intento de alta con credenciales vacías.");
            return false;
        }

        if (rol == null) {
            System.out.println("Registro: No se definió un Rol válido.");
            return false;
        }
        ...
        if (resultadoExitoso) {
            System.out.println("Registro: Transacción completada con éxito para: " + email);
            return true;
        } else {
            System.out.println("Registro: El repositorio rechazó la operación ( Email/DNI duplicado o Explotó la BD. ).");
            return false;
        }
    }
}