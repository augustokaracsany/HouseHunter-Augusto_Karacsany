...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2026 a las 02:13:38
...
(1, 1, 'Keynote de Apertura: Innovación AI', 'Presentación de las metas tecnológicas y bienvenida institucional.', 'ALTA', 'CHARLAS', '09:00:00'),
(2, 1, 'Workshop Técnico: Java Avanzado', 'Laboratorio práctico interactivo sobre concurrencia y JPA.', 'MEDIA', 'COWORK', '14:30:00'),
(3, 1, 'After Office & Networking', 'Espacio libre de recreación con barra de tragos y música en vivo.', 'BAJA', 'RECREACION', '19:00:00'),
(4, 1, 'TEST', 'DESCTEST', 'ALTA', 'OTROS', '12:30:05');
...
INSERT INTO `lista_invitados_previa` (`id`, `id_reserva`, `dni`, `nombre`, `apellido`, `celular`, `dni_companero`, `token_acceso`) VALUES
(1, 1, '44555666', 'Luca', 'Borrelli', '1122334455', '44728397', '2377'),
(2, 1, '44728397', 'Franco', 'Colapinto', '1155667788', '44555666', '1862'),
(3, 1, '12345678', 'Robert', 'Trebor', '1199887766', '0', '8454'),
(4, 1, '99888777', 'Alfonso Gutierrez', '', '4745450955', '', '8033'),
(5, 1, '11222333', 'Eustaquio Ramirez', '', '', '', '7052');
...
(1, 2, 'GLOBANT-2026', '2026-06-01', '2026-06-05', 50, NULL, '2026-05-26 00:41:42');
...
(8, 'invitado9@gmail.com', '$2a$10$DdEv1MMiV7y4lIY9V4/arO8PUdc5PaOg5O2il.MnxbOZ3Blb1kxpy', 'INVITADO'),
(9, 'invitado10@gmail.com', '$2a$10$sxGcXNaIN2aI5C3z5knUJuLmkSbYeU.Gp/Akh/06VcyZAJlm1S9Uu', 'INVITADO');
